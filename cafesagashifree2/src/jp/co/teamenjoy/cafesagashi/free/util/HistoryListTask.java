...
import jp.co.teamenjoy.cafesagashi.free.CafeListPageActivity;
...
public class HistoryListTask extends AsyncTask<Object, Integer, String> {

	private CafeListPageActivity mActivity;
	...
	private double mLng;
	// コンストラクタ
	public HistoryListTask(CafeListPageActivity activity, Geocoder geocoder) {
		mActivity = activity;
		mGeocoder = geocoder;
		// データベースを書き込み用にオープンする
