...
public class CafeWriteDataHelper extends SQLiteOpenHelper{
	...
	// データベースのファイル名
    static final String DB_NAME_ASSET="cafeSagashiAnd.db";
    
    // データベースのファイル名
    static final String DB_NAME_ZIP="cafeSagashiAnd.db.zip";
    
    private static String DB_NAME = "cafeSagashiAnd";
    
    // テーブルの名前
    static final String TABLE = "cafeMaster";
    static final String TAG = "CafeDataHelper";
	...
	public CafeWriteDataHelper(Context context) {
